...
<body>
	...
	<div class="wrap-movie-chart"
		...
		<div class="sect-sorting">
			...
			<select	name="order_type" style="width: auto; height: 30px;">
			<c:choose>
		...
		<div class="sect-movie-chart">
			<ol>
				<!-- 영화 7건만 표시 -->
				<c:forEach var="row" begin="0" end="6" items="${list}" varStatus="status">
					<li>
						<div class="box-image">
							<c:choose>
							...
							<span class="thumb-image"> 
								<img src="${path}/sangjin/resource/image/${row.img_url}"> <!-- 영화포스터 -->
						...
						<div class="box-contents">
							...
							</a> <span class="txt-info"> <strong> 
							<!-- 개봉일자 -->
							<fmt:formatDate	value="${row.release_date}" pattern="yyyy.MM.dd" /> <span>개봉</span>
							</strong>
							</span>
						</div>
					</li>
