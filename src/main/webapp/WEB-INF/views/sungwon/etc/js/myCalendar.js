function myCalendar(id, date,r_date) {
	...
	calendar += '			<thead>';
	calendar += '				<tr>';
	calendar += '				  <th style="text-align:center;" class="sun" scope="row"><h3><label class="label label-danger">일</label></h3></th>';
	calendar += '				  <th style="text-align:center;" class="mon" scope="row"><h3><label class="label label-success">월</label></h3></th>';
	calendar += '				  <th style="text-align:center;" class="tue" scope="row"><h3><label class="label label-success">화</label></h3></th>';
